 ...
 */
@Controller
@RequestMapping("/survey_qu_radio")
public class SurveyQuRadioController extends BaseController{
    ...
    private Question ajaxBuildSaveOption(HttpServletRequest request) throws UnsupportedEncodingException {
        ...
        for (String key : optionNameMap.keySet()) {
            //Object optionId=request.getParameter("optionId_"+key);
    ...
    public AjaxResult delete(HttpServletRequest request) {
        try{
            ...
            quRadioService.delete(Long.valueOf(quItemId.toString()));
            return success("删除成功");
        }catch(Exception e){
            e.printStackTrace();
            return fail("删除失败");
