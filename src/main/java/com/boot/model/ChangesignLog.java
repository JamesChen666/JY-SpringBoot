 ...
 * @author chenjiang
 */
@Table(name="student_changesign_log")
public class ChangesignLog implements Serializable{
	  ...
	  public void setApprovaler(Integer approvaler) {
		this.approvaler = approvaler;
	  }
	  public Integer getApprovaler() {
		return approvaler;
	  }
